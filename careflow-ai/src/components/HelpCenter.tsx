    ...
    return (
        <>
            <button
                ...
                className="p-2 text-slate-500 hover:text-teal-600 transition-colors rounded-full hover:bg-teal-50 relative group"
                title="Help & Support"
            >
            ...
            <div className={`fixed inset-y-0 right-0 w-full sm:w-96 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="h-full flex flex-col">
                    {/* Header */}
                    <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-teal-600 to-emerald-600 text-white">
                        ...
                        {selectedTopic ? (
                            <div className="p-6">
                                <button
                                    ...
                                    className="mb-4 text-sm text-teal-600 hover:text-teal-700 flex items-center font-medium"
                                >
                                    <ChevronRight className="w-4 h-4 rotate-180 mr-1" />
                                    Back to topics
                                </button>

                                <h3 className="text-xl font-bold text-slate-900 mb-2">{activeTopic?.title}</h3>
                                <span className="inline-block px-2 py-1 bg-slate-100 text-slate-600 text-xs rounded-full mb-6">
                            ...
                            <div className="p-6">
                                <div className="relative mb-6">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition-shadow"
                                    />
                                </div>
                                            ...
                                            <div className="space-y-2">
                                                {topics.map(topic => (
                                                    <button
                                                        ...
                                                        className="w-full text-left p-3 rounded-lg hover:bg-slate-50 transition-colors border border-slate-100 hover:border-teal-100 group"
                                                    >
                                                        <div className="flex items-center justify-between">
                                                            <span className="text-sm font-medium text-slate-700 group-hover:text-teal-700">
                                                                {topic.title}
                                                            </span>
                                                            <ChevronRight className="w-4 h-4 text-slate-300 group-hover:text-teal-400" />
                                                        </div>
                                                    </button>
                                                ))}
                                            </div>
                    ...
                    <div className="p-4 bg-slate-50 border-t border-slate-200">
                        <a
                            href="#"
                            className="flex items-center justify-center text-sm text-slate-600 hover:text-teal-600 transition-colors"
                        >
